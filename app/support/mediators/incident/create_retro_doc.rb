...
module Mediators::Incident
  class CreateRetroDoc < Mediators::Base
    ...
    def initialize(auth:, id:, title:, postmortem_date: false, dev_mode: false)
    ...
    def execution_req
      Google::Apis::ScriptV1::ExecutionRequest.new(function: Config.google_script_function, dev_mode: @dev_mode, parameters: [ @id, @title, @postmortem_date ])
    end
